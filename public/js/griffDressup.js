...
// Actual game start
class GriffDressup extends Phaser.Scene
{
    constructor ()
    {
        super({
    ...
    {  
        ...
        this.load.image('GriffFeaturesBtn', './images/GriffFeaturesBtn.png');
        this.load.image('GriffSizeBtn', './images/GriffSizeBtn.png');
        ...
        this.load.image('WingsBtn', './images/WingsBtn.png');
        this.load.image('UnicornBtn', './images/UnicornBtn.png');
    ...
    create (data)
    {
        ...
        const patternSlider = game.helper.makeSelector(164, 285, 4, 'pattern', ['Drifter', 'Duochrome', 'Shining', 'Stealthy', 'Harfang (Epic)'])
            ...
            let hairBtn = game.helper.makeTabButton('GriffFeaturesBtn', hairTab, 303, 250)
            let sizeBtn = game.helper.makeTabButton('GriffSizeBtn', sizeTab, 303, 314)
            ...
            game.helper.makeAnimalBtn('UnicornBtn', 'UniDressup')
            game.helper.makeWingsBtn()
